...
//!
//! Builds the axum router via `agentpalace_server::build_router`, binds a real
...
async fn spawn_server(config: AgentPalaceConfig, token_file: PathBuf) -> std::net::SocketAddr {

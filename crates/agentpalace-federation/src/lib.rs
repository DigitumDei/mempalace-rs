//! Wire-types (serde DTOs) shared between the AgentPalace federation HTTP server
...
pub struct InfoResponse {
    /// Semver string of the running AgentPalace server binary.
    #[serde(default)]
...
//
// Wire mirrors of the storage types in `agentpalace-storage/src/coordination.rs`.
// This crate must not depend on `agentpalace-storage` (see the crate-level doc
// comment), so these are independent types with the same shape;
// `agentpalace-server` converts between the two. Timestamps are plain RFC 3339
...
/// Mirrors `agentpalace_storage::coordination::TaskState`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
...
/// Wire mirror of `agentpalace_storage::coordination::Task`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// `agentpalace_storage::coordination::NewTask`, except `created_by` is the
...
/// Wire mirror of `agentpalace_storage::coordination::Message`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// `agentpalace_storage::coordination::NewMessage`, except `sender` is claimed,
/// not authoritative.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
pub struct InboxQuery {
    ...
    /// the local `agentpalace_inbox_read` tool's `recipient` argument.
    pub recipient: String,
...
/// Wire mirror of `agentpalace_storage::coordination::Artifact`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// `agentpalace_storage::coordination::NewArtifact`, except `created_by` is
...
/// Wire mirror of `agentpalace_storage::coordination::TaskResult`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// `agentpalace_storage::coordination::NewTaskResult`, except `created_by` is
/// claimed, not authoritative.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
/// Wire mirror of `agentpalace_storage::coordination::CoordinationEvent`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]

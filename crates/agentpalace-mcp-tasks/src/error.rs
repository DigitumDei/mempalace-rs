...
/// Errors raised while translating between MCP Tasks wire shapes and AgentPalace storage types.
...
pub enum McpTasksError {
    ...
    /// `agentpalace_storage::coordination::LEASE_DURATION_OUT_OF_RANGE`'s handling of the same

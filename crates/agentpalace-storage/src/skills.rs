...
mod tests {
    ...
    fn agent_skill(s: &SkillStore, author: &str, key: &str) -> Skill {
        s.propose_skill(&NewSkill {
            skill_id: "coordinate-with-agentpalace".into(),
            scope: SkillScope::Agent,
            wing: None,
            applicability: "when coordinating multiple workers".into(),
            instructions_ref: "skills/coordinate-with-agentpalace/SKILL.md".into(),
            required_capabilities: vec!["coordination".into()],
            required_tools: vec!["agentpalace_task_create".into()],
    ...
    fn list_skills_filters_by_scope_and_status() {
        ...
        assert_eq!(promoted_agent[0].skill_id, "coordinate-with-agentpalace");

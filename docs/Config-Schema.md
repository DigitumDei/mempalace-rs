...
| `MEMPALACE_LINEAGE_ID` | `mempalace-mcp` — **only** | Binds wake-up and identity packets to an existing lineage. Model-facing tools cannot override it; a missing bound lineage fails closed. |

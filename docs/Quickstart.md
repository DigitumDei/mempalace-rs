...
Point your MCP client at the `mempalace-mcp` binary. No arguments are needed: the server speaks stdio MCP and exposes all 69 tools during `initialize`/`tools/list`.
